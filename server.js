    ...
    eventId.forEach(function(events) {
        axios.get("http://ufc-data-api.ufc.com/api/v3/us/events/" + events + "/fights").then(function(eventFights) {
            eventFights.data.forEach(function(fightsList) {
                ...
                // let fightsList = eventFights.data[0];
...
// axios.get("http://ufc-data-api.ufc.com/api/v3/us/events/" + "649234" + "/fights").then(function(results) {
//     results.data.forEach(function(fights) {
//         console.log(fights.fighter1_first_name);
//     })
